...
//      KeepTailLWS             = 0x8000000,
    ...
    public abstract partial class UriParser {
        ...
        // This is where we will diverge from .NET library.  We will have this to true.  I am only keeping this function so we can see
        // which Uri methods have been using this for investigation purpose.
        internal static bool ShouldUseLegacyV2Quirks
        {
            get
            {
                // .NET would have the below code.  s_QuirksVersion is set based on .NET version from BinaryCompatiblity. This has been a point of contention from migrating from 4.0 to 4.5. 
